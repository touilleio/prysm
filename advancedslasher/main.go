...
import (
	...
	"github.com/prysmaticlabs/prysm/advancedslasher/flags"
	"github.com/prysmaticlabs/prysm/advancedslasher/node"
...
func main() {
	app := cli.App{}
	app.Name = "advanced slasher"
	app.Usage = `launches an optimized slasher implementation for Prysm`
